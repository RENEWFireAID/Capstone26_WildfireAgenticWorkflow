    ...
    <div className="flex w-full min-h-screen">
      ...
      <main className="flex-1 flex flex-col">
        ...
        <div className="bg-[#003366] px-12 py-10">
          <p className="text-[#FFCC33] text-xs font-semibold tracking-widest uppercase mb-1">FireAID</p>
          <div className="flex items-center gap-4"><img src="/uaf-logo.png" alt="UAF" style={{height:48,width:"auto",mixBlendMode:"screen"}} /><h1 className="text-3xl font-bold text-white tracking-tight">Apps</h1></div>
          <p className="text-blue-200 text-sm mt-1">Select a tool to get started</p>
        </div>
